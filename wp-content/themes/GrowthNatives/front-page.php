                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-heading-<?php echo $key + 1; ?>">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapse-<?php echo $key + 1; ?>"
                                            aria-expanded="false"
                                            aria-controls="flush-collapse-<?php echo $key + 1; ?>">
                                        <?php
                                        if (!empty($value['accordian_icon']) && isset($value['accordian_icon'])):
                                            ?>
                                            <span class="nav-logo">
                                            <img src="<?php echo $value['accordian_icon']['url'] ?>"
                                                 alt="<?php echo $value['accordian_icon']['alt'] ?>">
                                        ...
                                        ?>
                                        <span><?php echo $value['accordion_item'] ?></span>
                                    </button>
                                </h2>
                                <div id="flush-collapse-<?php echo $key + 1; ?>" class="accordion-collapse collapse"
                                     aria-labelledby="flush-heading-<?php echo $key + 1; ?>"
                                     data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <div class="nav nav-pills upper-child "
                                             id="acc-child-pills-tab-<?php echo $key + 1; ?>"
                                             role="tablist"
                                             aria-orientation="vertical">
                                            <?php
                                            $childAccordion = $value['accordion_content'];
                                            foreach ($childAccordion as $childKey => $childValue):
                                                ?>
                                                <button class="nav-link <?php echo $childKey == 0 ? 'active' : '' ?>"
                                                        id="acc-child-tab-<?php echo $childKey + 1 + $num ?>"
                                                        data-bs-toggle="pill"
                                                        data-bs-target="#acc-child-tab-content-<?php echo $childKey + 1 + $num ?>"
                                                        type="button"
                                                        role="tab"
                                                        aria-controls="acc-child-tab-content-<?php echo $childKey + 1 + $num ?>"
                                                        aria-selected="true">
                                                    <?php echo $childValue['item_name'] ?>
                                                </button>
                                            <?php
                                            endforeach;
                                            ?>
                                        ...
                                        <div class="tab-content"
                                             id="acc-child-tab-content-wrapper-<?php echo $key + 1 ?>">
                                            <?php
                                            foreach ($childAccordion as $childKey => $childValue):
                                                ?>
                                                <div class="tab-pane fade <?php echo $childKey == 0 ? 'show active' : '' ?>"
                                                     id="acc-child-tab-content-<?php echo $childKey + 1 + $num ?>"
                                                     role="tabpanel"
                                                     aria-labelledby="acc-child-tab-<?php echo $childKey + 1 + $num ?>">
                                                    <h6>
                                                        <?php echo $childValue['description'] ?>
                                                    </h6>
                                                    <div class="tab-link">
                                                        <a href="<?php echo !empty($childValue['read_more']) ? $childValue['read_more']['url'] : 'javascript:void(0)' ?>">
                                                            <?php echo $childValue['read_more']['title'] ?></a></div>
                                                </div>
                                            <?php
                                            endforeach;
                                            $num += $childKey + 1;
        ...
        if (get_row_layout() == 'testimonial'):
            ...
            <div class="happy-client spacing">
                <div class="container">
                    ...
                    <div class="quote-img">
                        <svg xmlns="http://www.w3.org/2000/svg" width="97.457" height="83.536"
                             viewBox="0 0 97.457 83.536">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                <div class="client-img">
                                                    <img src="<?php echo $value['profile_image']['url'] ?>"
                                                         alt="Happy Client">
                                                    <div class="play-button">
                                                        <a href="" data-bs-toggle="modal"
                                                           data-bs-target="#youtube-modal"
                                                           dataYoutube="<?php echo $value['video_link']['url'] ?>">
            ...
            <!-- modals -->
            <div class="modal fade" id="youtube-modal" data-bs-keyboard="false" tabindex="-1"
                            ...
                            <div class="case-study-img">
                                ...
                                if (isset($image_text) && !empty($image_text) || isset($image['url']) && !empty($image['url'])) :
                                    ...
                                    <div class="percentage">
                                        <h4><?php echo $image_text['percentage'] ?>
                                            <span><?php echo $image_text['text'] ?></span></h4>
                                    </div>
                                    <div class="study-img">
                                            ...
                                            <div class="practices-card">
                                                <a href="javascript:;">
                                                    <div class="card-feature-image">
                                                        <img src="<?= esc_url($thumbnail[0]) ?>" class="card-img-top"
                                                             alt="card-image">
                                                    </div>
                                                    <div class="card-body">
                            ...
                            if (isset($btn) && !empty($btn)):
                                foreach ($btn as $value) :
                                    ...
                                    <div class="explor-cta">
                                        <a href="javascript:;"
                                           class="custom-outline-btn btn"><?php echo $value['text'] ?></a>
                                    </div>
                                <?php
                                endforeach;
                            endif;
